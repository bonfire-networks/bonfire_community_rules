...
defmodule Bonfire.CommunityRules.MixProject do
  use Mix.Project
  ...
  def project do
    ...
    [
      ...
      description: "An extension for Bonfire",
        ...
        source_url: "https://github.com/bonfire-networks/bonfire_community_rules",
        package: [
          licenses: ["AGPL-3.0"],
          links: %{
            "Repository" => "https://github.com/bonfire-networks/bonfire_community_rules",
            "Hexdocs" => "https://hexdocs.pm/bonfire_community_rules"
          }
        ],
        docs: [
